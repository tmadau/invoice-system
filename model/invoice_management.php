<?php
    ...
    class InvoiceSystem {
        ...
        function add_invoice_items($business_id, $POST) {
            try {
                for ($counter = 0; $counter < count($POST['product_code']); $counter++) {
                    ...
                    $items_counter = array($POST['id'], $POST['product_code'][$counter], $POST['product_name'][$counter], $POST['quantity'][$counter], $POST['price'][$counter], $POST['total'][$counter]);
        ...
        function update_invoice($business, $address, $before_tax, $total_tax, $per_tax, $after_tax_total, $amount_paid, $amount_due, $note) {
            try {
